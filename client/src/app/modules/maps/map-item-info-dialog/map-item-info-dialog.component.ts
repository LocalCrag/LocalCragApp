...
export class MapItemInfoDialogComponent {
  ...
  public openItem() {
    ...
    if (this.feature.properties.sector) {
      this.router.navigate(['/topo', this.feature.properties.sector.crag.slug, this.feature.properties.sector.slug])
    }
    if (this.feature.properties.area) {
      this.router.navigate(['/topo', this.feature.properties.area.sector.crag.slug, this.feature.properties.area.sector.slug, this.feature.properties.area.slug])
    }
    if (this.feature.properties.topoImage) {
      this.router.navigate(['/topo', this.feature.properties.topoImage.area.sector.crag.slug, this.feature.properties.topoImage.area.sector.slug, this.feature.properties.topoImage.area.slug, 'topo-images'], {fragment:this.feature.properties.topoImage.id})
    }
  }
  ...
  public getCanOpenFeature() {
    return this.feature?.properties && (this.feature.properties.type === MapMarkerType.CRAG || this.feature.properties.type === MapMarkerType.SECTOR || this.feature.properties.type === MapMarkerType.AREA || this.feature.properties.type === MapMarkerType.TOPO_IMAGE)
  }

...
export const selectAppLevelAlertsState = createFeatureSelector<AppLevelAlertsState>('appLevelAlerts');

export const selectShowRefreshTokenAboutToExpireAlert = createSelector(
  selectAppLevelAlertsState,
  appLevelAlertsState => appLevelAlertsState.showRefreshTokenAboutToExpireAlert
);

...
export class TopoImagesService {
  ...
  public addTopoImage(
    ...
    return this.http
      .post(this.api.topoImages.add(areaSlug), TopoImage.serialize(topoImage))
  ...
  public getTopoImages(areaSlug: string): Observable<TopoImage[]> {
    return this.http
      .get(this.api.topoImages.getList(areaSlug))
      .pipe(
  ...
  public getTopoImage(id: string): Observable<TopoImage> {
    return this.http
      .get(this.api.topoImages.getDetail(id))
      .pipe(map(TopoImage.deserialize));
  }
   ...
   * @return Observable of null.
   */
  public deleteTopoImage(
    areaSlug: string,
    topoImage: TopoImage,
  ): Observable<null> {
    return this.http
      .delete(this.api.topoImages.delete(topoImage.id))
      .pipe(map(() => null));
  }

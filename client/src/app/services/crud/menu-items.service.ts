...
export class MenuItemsService {
  ...
  public getMenuItems(): Observable<MenuItem[]> {
    return this.http.get(this.api.menuItems.getList()).pipe(map((menuItemListJson: any) => menuItemListJson.map(MenuItem.deserialize)));
  }
  ...
  public getMenuItem(id: string): Observable<MenuItem> {
    return this.http.get(this.api.menuItems.getDetail(id)).pipe(map(MenuItem.deserialize));
  }
  ...
  public getCragMenuStructure(): Observable<Crag[]> {
    return this.http.get(this.api.menuItems.getCragMenuStructure()).pipe(map((cragListJson: any) => cragListJson.map(Crag.deserialize)));
  }

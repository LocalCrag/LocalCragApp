...
describe('httpUrlValidator', () => {
  ...
  it('should accept correct URLs', () => {
    ...
    const correctUrlCtrl1ValidationResult1 = httpUrlValidator()(correctUrlCtrl1);
    expect(correctUrlCtrl1ValidationResult1).toBeNull();

    const correctUrlCtrl2 = new FormControl('http://localcrag.de');
    const correctUrlCtrl1ValidationResult2 = httpUrlValidator()(correctUrlCtrl2);
  ...
  it('should not accept URLs without TLD', () => {
    ...
    const correctUrlCtrl1ValidationResult2 = httpUrlValidator()(correctUrlCtrl2);
    expect(correctUrlCtrl1ValidationResult2).toEqual(jasmine.objectContaining({
      invalidHttpUrl: true
    }))
  });

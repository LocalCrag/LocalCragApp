...
export enum NotificationIdentifier {
  ...
  UNARCHIVED_ERROR = 'UNARCHIVED_ERROR',
  ...
  INSTANCE_SETTINGS_ERROR_MIGRATION_IMPOSSIBLE = 'INSTANCE_SETTINGS_ERROR_MIGRATION_IMPOSSIBLE',
  ...
  SCALE_CREATED_ERROR = 'SCALE_CREATED_ERROR',
  SCALE_UPDATED = 'SCALE_UPDATED',
  SCALE_UPDATED_ERROR = 'SCALE_UPDATED_ERROR',
  SCALE_DELETED = 'SCALE_DELETED',
  SCALE_DELETED_ERROR = 'SCALE_DELETED_ERROR',
}

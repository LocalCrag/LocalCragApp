...
- `*-gym.json` files only override strings that must differ in gym-mode instances. Do not copy every new key into gym locales — only add a gym entry when the outdoor/default text should be replaced.

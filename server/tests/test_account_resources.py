...
def test_delete_own_user_success(client, member_token):
    ...
    rv = client.delete("/api/account/delete-own-user", token=member_token, json=None)
...
def test_delete_own_user_forbidden_for_superadmin(client, superadmin_token):
    rv = client.delete("/api/account/delete-own-user", token=superadmin_token, json=None)
...
def test_delete_own_user_unauthorized(client):
    rv = client.delete("/api/account/delete-own-user", json=None)

...
def test_successful_sync_line_paths_create_update_delete_and_reorder(client, moderator_token):
    ...
    rv = client.put(
        ...
        json={
            "linePaths": [
                {
                    "id": existing_line_paths[1]["id"],
                    "line": existing_line_paths[1]["line"]["id"],
                    "path": updated_path,
                },
                {
                    "line": str(stairs.id),
    ...
    assert res[1]["line"]["id"] == str(stairs.id)
    ...
    assert line_paths[0]["id"] == existing_line_paths[1]["id"]
    assert line_paths[1]["line"]["id"] == str(stairs.id)

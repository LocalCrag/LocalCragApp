...
line_args = {
    ...
    "linepath": fields.Dict(required=True, allow_none=False),
    ...
    "crimpy": fields.Boolean(required=True, allow_none=False),
    ...
    "wall": fields.Boolean(required=True, allow_none=False),

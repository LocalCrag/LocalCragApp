...
def upgrade():
    ...
    with op.batch_alter_table("areas", schema=None) as batch_op:
        batch_op.add_column(sa.Column("default_boulder_scale", sa.String(length=32), nullable=True))
        batch_op.add_column(sa.Column("default_sport_scale", sa.String(length=32), nullable=True))

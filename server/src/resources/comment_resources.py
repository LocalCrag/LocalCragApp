...
class CreateComment(MethodView):
    ...
    def post(self):
        ...
        #    If this is a reply and the parent author is an admin/superadmin and will receive a reply mail,
        #    skip the general admin notification for that user to avoid duplicate mails.

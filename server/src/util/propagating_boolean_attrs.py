...
def update_line_propagating_boolean_attr(line: Line, value: bool, attr: str, is_recursive_call=False, set_additionally=None):
...
def update_area_propagating_boolean_attr(area: Area, value: bool, attr: str, is_recursive_call=False, set_additionally=None):
...
def update_sector_propagating_boolean_attr(sector: Sector, value: bool, attr: str, is_recursive_call=False, set_additionally=None):
...
def update_crag_propagating_boolean_attr(crag: Crag, value: bool, attr: str, is_recursive_call=False, set_additionally=None):
